...
import {
  useActivityContext,
  selectMainSummaryStats,
  selectExtraSummaryStats,
    ...
    <div className="actions">
      ...
      <div className="buttons">
        ...
        <Button
          ...
          onClick={() => navigate("/sleep/create")}
          size="small"
        >
          {"Log Sleep"}
        </Button>
        <Button
          className="outline aqua"
      ...
      <div className="content">
        ...
        <div className="stats">
          <div className="main">
            <SummaryStat
              ...
              stat={{
                ...
                value: mainSummaryStats.totalExerciseMinutes,
              }}
            />
            <SummaryStat
              color="purple"
              ...
              stat={{
                ...
                value: mainSummaryStats.averageHoursSleep,
              }}
            />
            <SummaryStat
              color="aqua"
              ...
              stat={{
                ...
                value: mainSummaryStats.averageDailyCalories,
              }}
            />
          </div>
          <h4>More Stats</h4>
          <div className="more">
            <SummaryStat
              stat={{
                title: `Maximum Hourly Calories`,
                value: extraSummaryStats.maxCaloriesInOneMeal,
              }}
              isAverage={false}
              color="teal"
              size="small"
            ...
            <SummaryStat
              stat={{
                ...
                value: extraSummaryStats.averageExerciseIntensity,
              }}
              isAverage={true}
              color="orange"
              size="small"
            ...
            <SummaryStat
              stat={{
                ...
                value: extraSummaryStats.totalHoursSlept,
              }}
              isAverage={false}
              color="red"
              size="small"
